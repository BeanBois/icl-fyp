...
# Modified InstantPolicyAgent that extends the original to support batching
class InstantPolicyAgent(BatchedInstantPolicyAgent):
    """
    ...
    # Keep all the original helper methods from your original implementation
    def _SE2_to_se2(self, T, eps=1e-6):
        """Convert SE(2) to se(2) - from your original implementation"""
