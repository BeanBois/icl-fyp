...
CONFIGS = {
    ...
    'MAX_DISPLACEMENT_PER_STEP' : PSEUDO_MAX_TRANSLATION * 3, # params is vibes. since pseudo game is downsampled quite a bit
    'MAX_DEGREE_PER_TURN' : PSEUDO_MAX_ROTATION * 3,
